...
function RegisterRoutes() {
    return {
        ...
        easyRoutes: ['organizations', 'users', 'groups', 'categories', 'tasks','milestones'], // Provide the names of your tables here and make a copy of app/modules/tasks with the same name
